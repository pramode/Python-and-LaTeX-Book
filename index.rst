...
prepare technical documents using LaTeX. A   majority of the students (and teachers) have a computing background 
limited to using Microsoft Windows for simple tasks like web browsing. Many of them don't  have
unrestricted access to the Net or even a PC. **An introduction to Python and LaTeX** has
the objective of providing a gentle introduction to computing to the above mentioned audience. 
...
to master Python syntax and idioms. There are plenty of great resources on the net for that, one of the best being
